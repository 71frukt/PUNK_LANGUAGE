...
void PopToEmptyRam(FILE *asm_file)                          // pop [BX++]   // BX - ������, AX - ������ ������
{
...
void PrintInitAsm(Node *init_node, FILE *dest_file)
{
    ...
    if(init_node->left->type == KEY_WORD && init_node->left->val.key_word->name == VAR_T_INDICATOR)     // ����������
    {
        ...
        if (init_node->right != NULL)                                                                   // ��� �������������, ��������, ��� ���������� �������  func(int a) � ���� ����� ������ pop[BX++]
...
void PrintCallAsm(Node *call_node, FILE *dest_file)
{
    ...
    fprintf(dest_file,  "%s %s: \n", AsmOperations[CALL_ASM].sym, call_node->left->left->val.prop_name->name);  // ������ � ����� ����� BP � res_of_func, �� ����� ����� �������� ����� ������ �� ������ �������

    fprintf(dest_file,  "%s CX  \n", AsmOperations[POP_ASM].sym);                                               // ����� ��������� ������� � CX
